-- FIX: Arreglar políticas RLS que causan recursión infinita (CORREGIDO)
...
DROP POLICY IF EXISTS "admin_moderator_select_all" ON users;
DROP POLICY IF EXISTS "admin_update_all" ON users;

-- 2. Crear políticas simples y seguras (USANDO 'id' EN LUGAR DE 'user_id')
