...
const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 pt-6 sm:pt-10 pb-20">
            <Helmet>
            ...
            <div className="container mx-auto px-4">
                <div className="mb-6 sm:mb-10">
                    ...
                    <p className="text-slate-400 text-sm sm:text-base">Bienvenido de nuevo, <span className="text-green-400 font-semibold">{user.username}</span></p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
                    <Button
                        onClick={() => navigate('/statistics')}
                        className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white h-12 sm:h-14 text-xs sm:text-sm"
                    >
                    ...
                    <Button
                        ...
                        className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white h-12 sm:h-14 text-xs sm:text-sm"
                    >
                    ...
                    <Button
                        ...
                        className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white h-12 sm:h-14 text-xs sm:text-sm"
                    >
